...
controlCajaApp.config(['$httpProvider', function ($httpProvider) {
    $httpProvider.interceptors.push(['$q', '$log', '$location', '$cookieStore', '$rootScope', function ($q, $log, $location, $cookieStore, $rootScope) {
        return {
