(function () {
    var controlCajaCtrl = function (movimientosFactory, maestrosFactory, totalFactory) {
        var scope = this;
    ...
    controlCajaApp.controller('ControlCajaCtrl', ['movimientosFactory', 'maestrosFactory','totalFactory', controlCajaCtrl]);
}());